...
curl -fsSL https://builds.dotnet.microsoft.com/dotnet/Sdk/10.0.100/dotnet-sdk-10.0.100-linux-x64.tar.gz -o dotnet-sdk.tar.gz
rm -rf /root/dotnet
mkdir -p /root/dotnet
...
rm /root/dotnet/templates/10.0.0/microsoft.dotnet.web.*
curl -fsSL https://github.com/duckdb/duckdb/releases/download/v1.4.2/duckdb_cli-linux-amd64.zip -o duckdb-cli.zip
curl -fsSL https://github.com/duckdb/duckdb/releases/download/v1.4.2/libduckdb-linux-amd64.zip -o libduckdb.zip
unzip -o duckdb-cli.zip -d duckdb
unzip -o libduckdb.zip -d duckdb
rm libduckdb.zip
rm duckdb-cli.zip
ln -f -s /root/duckdb/duckdb /bin/duckdb
curl -fsSL https://github.com/PowerShell/PowerShell/releases/download/v7.6.0-preview.5/powershell-7.6.0-preview.5-linux-x64.tar.gz -o powershell.tar.gz
...
curl -fsSL https://github.com/rclone/rclone/releases/download/v1.72.0/rclone-v1.72.0-linux-amd64.zip -o rclone.zip
...
rm -rf /root/dotnet/sdk/10.0.100/DotnetTools/dotnet-format
rm -rf /root/dotnet/sdk/10.0.100/DotnetTools/dotnet-watch
rm -rf /root/dotnet/sdk/10.0.100/FSharp
...
apt-get -y purge firmware-netronome firmware-qcom-soc firmware-amd-graphics firmware-sof-signed firmware-atheros firmware-libertas raspi-firmware
apt-get -y purge nvidia-*
apt-get -y purge firmware-nvidia-*
rm -rf /usr/share/doc/*
apt-get clean
apt-get autoclean
rm -rf /var/lib/apt/*
